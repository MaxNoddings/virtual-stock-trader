...
<?php
    ...
    $sql = "INSERT INTO transactions (user_id, stock_id, shares, purchase_price, transaction_type) VALUES ($user_id, $stock_id, $shares, $purchase_price, 'buy')";
    // Issue the query
...
<html lang="en">
	<head>
		<title> Buy Confirmation Page </title>
	</head>
<body>
	<h3>
		Your buy order of ____ has been confirmed!
	</h3>
